...
├── den_test_python_project_template_             # The main python package for the project
...
e.g: `cat den_test_python_project_template_/VERSION` will get the project version without harming
